...
// import openMenu from './webe-sidebar.js';

const serviceHTML = /*html*/ `
    ...
    <div class="container">
        <aside class="sidebar" data-sidebar>
            <div class="top-sidebar">
                <a href="#" class="channel-logo"><img class="girl-chair" src="/components/webeSidebar/images/girl_chair_1.png" alt="Channel Logo"></a>
                <div class="hidden-sidebar your-channel">Summer's Dress</div>
                <div class="hidden-sidebar channel-name">A Genuine "Tailored Made" Art</div>
                <hr class="hidden-sidebar hr-line" />
            </div>
            <div class="middle-sidebar">
                <ul class="sidebar-list">
                <li class="sidebar-list-item active">
                    <a href="#" class="sidebar-link flipX">
        ...
        <main class="content"><home-page_shell class="home-page_shell"></home-page_shell></main>
    </div>
