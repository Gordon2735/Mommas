    ...
    <div class="container">
        <aside class="sidebar" data-sidebar>
            <div class="top-sidebar">
                <a href="#" class="channel-logo"><img src="/components/webeSidebar/images/girl_chair_1.png" alt="Channel Logo"></a>
                <div class="hidden-sidebar your-channel">Your channel</div>
                <div class="hidden-sidebar channel-name">Summer's Dress</div>
            </div>
